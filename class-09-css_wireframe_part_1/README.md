...
**- Let's go over the career coaching assignments briefly. These will all be due at midnight a week from Sunday. Plan/coordinate carefully.**

**- Code Review**

`10-minute break`

**- Code Review** *[30-40 minutes]*

**- Wireframing** *[20 minutes]*

`10-minute break`

**- [JS Debugging (Vinicio)](#debugging)**

**- 11:50am: Admissions team will stop by and go over the 301 enrollment process**
