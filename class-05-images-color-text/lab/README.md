...
1. Go to GitHub and create a repo called "lab-5"
2. Clone that repo.
3. Create the following files: index.html, app.js, tests.js
4. Copy/paste the code from those files in the lab directory in the class repository
